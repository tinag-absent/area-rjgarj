...
export async function GET(req: NextRequest) {
  ...
  // [AE-021] ユーザーが参照できるルールタイプのみ許可
  const PUBLIC_RULE_TYPES = ["xp_rule", "arg_keyword", "novel_rule"] as const;
  if (!PUBLIC_RULE_TYPES.includes(type as typeof PUBLIC_RULE_TYPES[number])) {
