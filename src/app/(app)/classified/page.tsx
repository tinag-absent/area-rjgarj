...
const DOCUMENTS = [
  {
    ...
    date: "1987-03-07",
    teaser: "海蝕機関の真の設立目的は、海蝕現象の「収束」ではない——",
    body: `第零条（非公開）
...
知った者は、引き返せない。`,
  },
  {
    ...
    date: "継続更新中",
    teaser: "「任務中の事故」として処理されたが、実際には次元境界に取り込まれた機関員の記録。",
...
K-004-???　未登録　— 消失日不明。
  ...
  },
  {
    ...
    date: "作成日：不明",
    teaser: "観測者は存在しない。これはプロトコルの名称ではなく、事実の記述である。",
    body: `観測者は存在しない。
...
それまでは、知らないほうが安全です。`,
  },
  {
    ...
    date: "1991-07-14",
    teaser: "第一号インシデント。現場派遣17名のうち帰還したのは3名。「収束の代償」の最初期記録。",
    ...
    <div className="animate-fadeIn" style={{ padding: "3rem 1.5rem", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p className="font-mono" style={{ fontSize: "0.875rem", color: "rgba(255,82,82,0.6)" }}>
          本ページの閲覧はシステムに記録されます。本内容の無断複製・漏洩は処分対象です。
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        {DOCUMENTS.map(doc => (
          <Link key={doc.id} href={`/classified/${doc.id}`} style={{ textDecoration: "none" }}>
            <div className="card" style={{
              borderLeft: `3px solid ${doc.color}80`,
              backgroundColor: `${doc.color}04`,
              cursor: "pointer",
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.4rem", flexWrap: "wrap" }}>
                      <span className="font-mono" style={{
                        ...
                        border: `1px solid ${doc.color}40`, flexShrink: 0,
                      }}>
                    ...
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "1rem", color: "white", marginBottom: "0.4rem" }}>
                      {doc.title}
                    </div>
                    <p className="font-mono" style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.6, margin: 0 }}>
                      {doc.teaser}
                    </p>
                  </div>
                  <svg width="14" height="14" fill="none" stroke={`${doc.color}60`} viewBox="0 0 24 24" style={{ flexShrink: 0, marginTop: "0.25rem" }}>
      ...
      <div className="font-mono" style={{ marginTop: "2rem", padding: "1rem", backgroundColor: "rgba(239,68,68,0.04)", border: "1px solid rgba(239,68,68,0.15)", fontSize: "0.65rem", color: "rgba(239,68,68,0.5)", lineHeight: 1.8 }}>
        ...
        <br />これ以上の情報は、異常スコアが基準値を超えた時に開示されます。
      </div>
    </div>
  );
}
