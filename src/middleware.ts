/**
 * src/middleware.ts — Edge Runtime 認証ガード
 *
 * Next.js が自動的に読み込むエントリポイント。
 * 関数名は `middleware`（または default export）である必要がある。
 * proxy.ts から移行済み。
 */
